...
(function () {
  ...
  if (!__l) { return; }
    var _ctx__loopcache0270782682720224 = { loop: _ctx.loop, color: _ctx.color, __k: _ctx.__k };
...
_output += "</li>\n        ";
  ...
  _ctx.loop = _ctx__loopcache0270782682720224.loop;
  _ctx.color = _ctx__loopcache0270782682720224.color;
  _ctx.__k = _ctx__loopcache0270782682720224.__k;
  _ctx__loopcache0270782682720224 = undefined;
})();
_output += "\n    </ul>\n    ";
} else {
_output += "\n    <div>\n        No colors!\n    </div>\n    ";
